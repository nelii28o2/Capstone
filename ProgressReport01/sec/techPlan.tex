...
\item View Course
\item Enroll Course
\item Create Assignment (this is in course-prof)
\item Assignment Information
\item Assignment Submissions
\item Assignment Test Cases
\item Assignment Repositories
\item Add test cases (this is in assignment but no modal in it)
\item Grade (this is in course-prof)
...
end points are designed using the RESTful (representational state transfer) web
