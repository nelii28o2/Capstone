...
When working on a project, it is important to look at project antecedents and
...
Educational Instituions outside of Puerto Rico have similar systems to the one
...
program assignments. This is achieved by comparing the program output with the
...
their output result is tested against an specific input. A few years ago in the
University of Puerto Rico at Maygauez a teaching asssitant (TA) for the Data
Structures course and former student, José Santuche, developed a small script
that would checkout his students' code, run some tests, compare the output and
send an email to the student with the results. The most copetitive product is
another web-based tool named Web-CAT. Web-CAT is an open-sourced automated
