...
%EC2 Instance specs: C1.Medium (Compute-optimized)
% Intel Xeon - 2 vCPU, 5 ECU, 350GB, $0.145 per Hour
% Auto-Scaling: $0.025 per Elastic Load Balancer-hour, $0.008 per GB of data processed by an Elastic Load Balancer
